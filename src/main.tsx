...
import { restorePersistedSessionEnvelopeV1 } from '@/application/session-persistence/index.ts'
...
const sessionStore = createBrowserGameSessionStore(restorePersistedSessionEnvelopeV1)
