...
import { loadNextGameSetupTemplate } from '@/application/game-setup/index.ts'
...
import { createBrowserNextGameSetupTemplateRepository } from '@/infrastructure/persistence/browser-next-game-setup-template-repository.ts'
...
const nextGameSetupTemplateRepository = createBrowserNextGameSetupTemplateRepository()
const initialNextGameSetupTemplate = loadNextGameSetupTemplate(nextGameSetupTemplateRepository)
...
createRoot(rootElement).render(
  <StrictMode>
    <App
      ...
      initialNextGameSetupTemplate={initialNextGameSetupTemplate}
    />
  </StrictMode>,
)
